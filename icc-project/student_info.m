...
%
%   info struct fields:
%       .student_id   - 202420624 (string, 예: '20210123')
%       .name         - 민지원 (string)
%       .team_members -  (cell array of struct, 개인 제출 시 빈 cell)
%       .course       - 과목 코드/이름 C049/민지원
%       .ai_usage     - 챗지피티 사용 + 범위 (string)
%
%   본 파일을 수정하지 않으면 -5점 감점 + 채점 시트 매칭 불가.

    info.student_id   = '202420624';
    info.name         = 'Min Jiwon';
    ...
    info.ai_usage = 'ChatGPT used for controller implementation assistance';
